...
import {downloadBinary, javyBinary, javyPluginBinary, wasmOptBinary, deriveJavaScriptBinaryDependencies, BinaryDependencies} from './binaries.js'
...
async function validateShopifyFunctionPackageVersion(fun: ExtensionInstance<FunctionConfigType>): Promise<BinaryDependencies> {
...
export interface JavyBuilder {
  bundle(fun: ExtensionInstance<FunctionConfigType>, options: JSFunctionBuildOptions, binaryDeps: BinaryDependencies): Promise<BuildResult>
  compile(fun: ExtensionInstance<FunctionConfigType>, options: JSFunctionBuildOptions, binaryDeps: BinaryDependencies): Promise<void>
}

export const DefaultJavyBuilder: JavyBuilder = {
  async bundle(fun: ExtensionInstance<FunctionConfigType>, options: JSFunctionBuildOptions, binaryDeps: BinaryDependencies) {
    return bundleExtension(fun, options, binaryDeps)
  },

  async compile(fun: ExtensionInstance<FunctionConfigType>, options: JSFunctionBuildOptions, binaryDeps: BinaryDependencies) {
...
export class ExportJavyBuilder implements JavyBuilder {
  ...
  async bundle(fun: ExtensionInstance<FunctionConfigType>, options: JSFunctionBuildOptions, binaryDeps: BinaryDependencies, processEnv = process.env) {
